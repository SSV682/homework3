...
import (
	...
	"notification-service/internal/provider/kafka"
	"notification-service/internal/provider/sql"
	"notification-service/internal/services/notification"
	"os"
	"os/signal"
	"syscall"
	"time"
...
func NewApp(configPath string) *App {
	...
	notificationService := notification.NewNotificationService(sqlProv)
	rs := handlers.NewRegisterServices(notificationService)
