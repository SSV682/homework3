...
import (
	...
	"delivery-service/internal/provider/kafka"
	"delivery-service/internal/provider/sql"
	"delivery-service/internal/services/delivery"
...
func NewApp(configPath string) *App {
	...
	processorConfig := delivery.Config{
	...
	processorService := delivery.NewProcessor(processorConfig)
	processorService.Run(context.Background())

	stockService := delivery.NewDeliveryService(sqlProv)
